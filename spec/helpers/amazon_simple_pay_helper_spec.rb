...
<form action=\"https://authorize.payments-sandbox.amazon.com/pba/paypipeline\" method=\"post\"><input id=\"amount\" name=\"amount\" type=\"text\" /><input id=\"accessKey\" name=\"accessKey\" type=\"hidden\" value=\"TEST_ACCESS_KEY\" /><input id=\"amazonPaymentsAccountId\" name=\"amazonPaymentsAccountId\" type=\"hidden\" value=\"TEST_ACCOUNT_ID\" /><input id=\"processImmediate\" name=\"processImmediate\" type=\"hidden\" value=\"1\" /><input id=\"isDonationWidget\" name=\"isDonationWidget\" type=\"hidden\" value=\"1\" /><input id=\"cobrandingStyle\" name=\"cobrandingStyle\" type=\"hidden\" value=\"logo\" /><input id=\"returnUrl\" name=\"returnUrl\" type=\"hidden\" value=\"http://test.host/donations/confirm\" /></form>
HTML
